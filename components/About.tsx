...
export default function About({ data }: { data?: AboutData }) {
  ...
  const paragraphs = data?.paragraphs || [
    "I'm Lucas, a full-stack developer who enjoys turning ideas into clear, useful, and well-built web applications. I work across frontend and backend, with attention to clean interfaces, maintainable code, and practical product decisions.",
    "I like building systems that feel smooth to use and simple to evolve, from polished React interfaces to APIs, databases, and integrations.",
  ];
